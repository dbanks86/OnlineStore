...
namespace OnlineStoreDataAccessLayer
{
    class ErrorService
    {
        ...
        {
            string logFile = String.Format(@"D:\Microsoft Visual Studio 2015\Projects\OnlineStore\OnlineStoreDataAccessLayer\ErrorLogs{0}.txt", "\\" + DateTime.Now.ToString("M-d-yyyy_h.mm.sstt.FFFFFFF"));
